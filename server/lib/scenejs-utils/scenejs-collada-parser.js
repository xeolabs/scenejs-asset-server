var jsonLib = require('./scenejs-json-builder');
var boundarybuilder = require("./boundary-builder");

/** @class Parses a COLLADA XML DOM into a JSON string that defines a SceneJS scene subgraph
 *
 * Requires:
 *
 *     scenejs-json-builder.js
 *     glge_xmlparser.js
 *
 *
 * @constructor
...
exports.newParser = function(jsonBuilder) {
    return new Parser(jsonBuilder);
};

var Parser = function(jsonBuilder) {  // Constructor
    ...
    this.parse = function(params, xmlDoc, callback) {
        ...
        this._boundaryBuilder = boundarybuilder.getBoundaryBuilder();
    ...
    this._getTextureData = function(profileCommonTag, textureTag, applyTo) {
        ...
        /* Asset server will marshal all the images into one place
         */
