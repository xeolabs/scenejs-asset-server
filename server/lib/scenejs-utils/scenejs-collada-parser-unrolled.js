exports.newParser = function(boundaryBuilder) {
    return new SceneJS_ColladaToJSONParser_Unrolled(boundaryBuilder);
};

/**
 * Collada-to-SceneJS JSON parser which optimises the JSON by "unrolling" instance-symbol relationships.
 *
 * Use this to parse Collada files that have been exported specially for SceneJS.
 */
var SceneJS_ColladaToJSONParser_Unrolled = function(boundaryBuilder) {  // Constructor
    ...
    /**
     * Finds every element in the xmlDoc and maps the by IDs
     */
    ...
    this._parseGeometry = function(geometryTag, materialSymbols) {
        ...
        for (var it = 0; it < trianglesList.length; it++) {
            ...
            function addGeometry() {  // ready to use in callback if required
                 ...
                 */
                this._boundaryBuilder.geometry(outputData.VERTEX);
