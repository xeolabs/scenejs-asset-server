 ...
 *             module: null,         // Optional, name of SceneJS module to wrap around subgraph, default is none
 *             cfgFilter: {
 *                 excludes: {
 *
 *                 }
 ...
 */
exports.newBuilder = function(cfg) {
...
var Builder = function(cfg) {
    ...
    this._indentStr = "";
    this._countIndents = cfg.module ? 2 : 0;
    ...
    this.openNode = function(name, cfg) {
        ...
        if (!this._openNode && this._module) { // Opening root node
            this._write("return ");
        }
    ...
    this._property = function(name, value) {
        ...
        if (typeof value == "number") {
            ...
            this._write(name + " : \"" + value + "\"");
        } else if (value._SceneJS_JSON_Builder_StringAssignment) {
            this._write(name + " : " + value.varName + " + \"" + value.strValue + "\"");
        } else {
    ...
    this.getJSON = function() {
        ...
        if (this._module) {
            this._json.unshift([
                "(function() {",
                "    var configs = {};",
                "    SceneJS.installModule(\"" + this._module + "\", {",
                "        init : function (cfg) {",
                "            configs = cfg;",
                "        },",
...
exports.newStringAssignment = function(varName, strValue) {
    return {
        _SceneJS_JSON_Builder_StringAssignment : true,
        varName : varName,
        strValue : strValue
    };
};